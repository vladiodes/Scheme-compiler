...
; The macro will first load the value 5+n into rax to get the size of the current frame.
; Next the macro repeats %1 times,
; copying the data from the new frame down to override the old frame.
; The value of %1 should be the size of the new frame, 5+m.
; Since m is known during compilation time
; (it's the length of the argument list of ApplicTP'),
; the expression m+5 is a constant, as required in the macro.
